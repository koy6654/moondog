...
const GameTitle: React.FC<PageTitleProps> = ({ title, subTitle }) => {
  return (
    <PageLayout>
      <div className="w-full h-full flex flex-col justify-center items-center mt-[40px] mb-[20px]">
        <p
          className="font-comic-sans-ms text-center text-[38px] font-normal leading-normal"
          style={{
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col items-center justify-center label mx-[0px] sm:mx-[0px] md:mx-[20px] lg:mx-[30px]">
            <p
              className="font-comic-sans-ms text-center"
              style={{
                fontWeight: 900,
